package com.gb.testingcourse.view.details
...
class DetailsActivity<V: View> : AppCompatActivity(), ViewDetailsContract {

    private val presenter: PresenterDetailsContract<V> = DetailsPresenter(this)
